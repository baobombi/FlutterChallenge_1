...
class PracticeScreenOne extends StatefulWidget {
  const PracticeScreenOne({Key? key}) : super(key: key);
  static const routeName = '/bai-tap-1';
  @override
  _PracticeScreenOne createState() => _PracticeScreenOne();
}
